...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <!----------- Modal ---------------------------->
                                    <div class="modal fade" id="modalFiche_Stagiaire" tabindex="-1" role="dialog"
                                        aria-hidden="true" aria-hidden="true" data-backdrop="static"
                                        data-keyboard="false">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="ajouter-stagiaire-form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="date_nsce"
                                                                name="date_nsce" required />
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="lieu_nsce">Lieu de naissance</label>
                                                            <input type="text" class="form-control" id="lieu_nsce"
                                                                name="lieu_nsce" placeholder="Lieu de naissance"
                                                                required />
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn-primary btn_AjoutOption"
                                                                    data-bs-toggle="modal"
                                                                    title="Ajouter un nouveau Pays" data-idselect="pays"
                                                                    data-urlajout="pays_set.php"
                                                                    data-urlget="pays_get_liste.php">
                                                                    <i class="fas fa-plus"></i>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    data-idselect="filiere"
                                                                    data-urlajout="filiere_set.php"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    data-idselect="niveau"
                                                                    data-urlajout="niveau_set.php"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <button type="button"
                                                                    class="btn btn-primary btn_AjoutOption"
                                                                    data-bs-toggle="modal"
                                                                    title="Ajouter un nouveau Type Etudiant"
                                                                    data-idselect="type" data-urlajout="type_set.php"
                                                                    data-urlget="type_get_liste.php">
                                                                    <i class="fas fa-plus"></i>
                                                                </button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-footer border-0">
                                                    ...
                                                    <button type="button" id="btn_fermer" class="btn btn-danger"
                                                        data-dismiss="modal">
                                                        Fermer
                                                    </button>
                                                </div>
                                    ...
                                    <div class="modal fade" id="modal_ajoutOption" tabindex="-1"
                                        aria-labelledby="modal_ajoutOptionLabel" tabindex="-1" role="dialog"
                                        aria-labelledby="secondModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modal_ajoutOptionLabel">Ajouter un
                                                        nouvel auteur</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="form_Modal_ajoutOption">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="nomOption"
                                                                required>
                                                            <input type="text" class="form-control" id="codeOption"
                                                                value="" hidden>
                                                ...
                                                <div class="modal-footer">
                                                    <button id="btn_fermerOption" type="button"
                                                        class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Fermer</button>
                                                    <button id="btn_enregistrerOption" type="button"
                                                        class="btn btn-primary"
                                                        id="btn_EnregitrerAuteur">Enregistrer</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-------------- Modal ajout Stage ------------------------------------------>
                                    <div class="modal fade" id="modalAjoutStage" tabindex="-1" role="dialog"
                                        aria-labelledby="modalAjoutStageLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalAjoutStageLabel">Ajouter un stage
                                                    </h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                ...
                                                <div class="modal-body">
                                                    <form id="formAjoutStage">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="objectif_stage"
                                                                name="objectif_stage" rows="3" required></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="si_objectif_atteint">Si Objectif atteint
                                                                ?</label>
                                                            <input type="checkbox" style="cursor: hand;"
                                                                id="si_objectif_atteint" name="si_objectif_atteint"
                                                                value="1">
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                                        id="btn_fermerStage">Fermer</button>
                                                    <button type="button" class="btn btn-primary"
                                                        id="btn_enregistrerStage">Enregistrer</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="modalListeStages" tabindex="-1"
                                        aria-labelledby="modalListeStagesLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalListeStagesLabel">Liste des stages
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
    ...
    $(document).ready(function() {
        ...
        $("#btn_nouv").click(function() {
            ...
            window.location.href = 'stagiaire_fiche.php?pageName=Stagiare';
        });
        ...
        $("#btn_fermer").click(function() {
            ...
            if (conditionEstRemplie) {
                ...
                alert(
                    "Vous ne pouvez pas fermer la fenêtre tant que les conditions ne sont pas remplies."
                );
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $('#resultat').html('<p style="color:green;">' + response.message +
                            '</p>');
                    } else {
                        $('#resultat').html('<p style="color:red;">Erreur: ' + response
                            .message + '</p>');
                    }
                },
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $.each(response.donnees, function(index, ligne) {
                            ...
                            rows += '<td data-date="' + ligne.date_nsce + '">' + date_nsce +
                                '</td>';
                            rows += '<td>' + ligne.lieu_nsce + '</td>';
                            rows += '<td data-code_pays="' + ligne.code_pays + '">' + ligne
                                .nationalite + '</td>';
                            rows += '<td data-code_ecole="' + ligne.code_ecole + '">' +
                                ligne.ecole + '</td>';
                            rows += '<td data-code_filiere="' + ligne.code_filiere + '">' +
                                ligne.filiere + '</td>';
                            rows += '<td data-code_niveau="' + ligne.code_niveau + '">' +
                                ligne.niveau + '</td>';
                            rows += '<td hidden data-code_type="' + ligne.code_type + '">' +
                                ligne.type + '</td>';
                            rows += '<td>' +
                                ...
                                '</button>' +
                                '<button type="button" class="btn btn-link btn-success btn-lg btn_ajouter_stage" data-code="' +
                                ligne.code + '">' +
                                '<i class="fa fa-plus-circle"></i> Stage' +
                                '</button>' +
                                '<button type="button" class="btn btn-linkbtn-info btn-lg btn-liste-stages" data-code="' +
                                ligne.code + '">' +
        ...
        $(".btn_AjoutOption").click(function() {
            ...
            var urlajout = $(this).data(
                'urlajout'); // Utilisation de .data() pour récupérer l'attribut data-urlajout
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        window.location.href = 'stage_liste.php?pageName=Stages pour ' +
                            nom_stagiaire + '&code_stagiaire=' +
                            code_stagiaire; // Rediriger vers la nouvelle page
                    } else {
        ...
        $(document).on('click', '.btn-liste-stages', function() {
            var code_stagiaire = $(this).data(
                'code'); // Récupération du code stagiaire via l'attribut data
            // Récupérer la ligne (tr) parente du bouton cliqué
            var $row = $(this).closest('tr');
            ...
            ouvrirListeStages(code_stagiaire,
                nom_stagiaire); // Appel de la fonction pour afficher les stages
        });
